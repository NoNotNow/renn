...
2. Layout: **BuilderHeader** (toolbar + gravity/shadows toggles); **EntitySidebar** (entity tree explorer with search and collapsible filters, add-entity dropdown, camera control/target/mode; group toolbar — see `feature-groups.md`); **SceneView** (main canvas); **PropertySidebar** (tabs: Properties, Scripts, Assets, Presets).
