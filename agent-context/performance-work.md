...
| 4 | **DPR quality setting**: `world.world.renderPixelRatio` (`'low'`=1×, `'medium'`=min(dpr,1.5) default, `'high'`=min(dpr,2)); select in World → Simulation panel; reactive `useEffect` in SceneView updates without scene reload | [`SceneView.tsx`](../src/components/SceneView.tsx), [`world/WorldSimulationSection.tsx`](../src/components/world/WorldSimulationSection.tsx), [`types/world.ts`](../src/types/world.ts) (`resolvedPixelRatio`) | **[x] 2026-04-22** |
