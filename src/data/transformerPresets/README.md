...
Each subfolder corresponds to a transformer type (`car2`, `input`, `person`). Add JSON files here to make them available in the Builder’s transformer template dialog.
