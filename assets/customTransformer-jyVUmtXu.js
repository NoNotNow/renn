var s=Object.defineProperty;var u=(r,e,t)=>e in r?s(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var o=(r,e,t)=>u(r,typeof e!="symbol"?e+"":e,t);import{i as BaseTransformer}from"./index-BjFzmwGw.js";class CustomTransformer extends BaseTransformer{constructor(e=10,t){super(e,!0);o(this,"type","custom");o(this,"code");this.code=t}setCode(e){this.code=e}transform(input,dt){try{const context={input,dt,getAction:e=>input.actions[e]??0,Math,PI:Math.PI},wrappedCode=`
        (function() {
          ${this.code}
        })()
